          ...
          {isLoading && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 sm:gap-8">
              {Array.from({ length: 4 }).map((_, index) => (
                ...
                >
                  <div className="h-48 sm:h-64 bg-gradient-to-br from-gray-200 to-gray-300"></div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative h-48 sm:h-64 overflow-hidden">
                      ...
                      {/* Unified Price Badge */}
                      <div className={`absolute top-3 sm:top-4 ${isRTL ? 'right-3 sm:right-4' : 'left-3 sm:left-4'} bg-gradient-to-r from-inovara-primary to-inovara-secondary text-white px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-bold shadow-lg`}>
                    ...
                    <div className="p-6 sm:p-8">
                      <div className={`flex items-start gap-4 mb-4 sm:mb-6 ${isRTL ? 'flex-row-reverse' : 'flex-row'}`}>
                        <div className={`flex-1 ${isRTL ? 'text-right' : 'text-left'}`}>
                          <h3 className="text-xl sm:text-2xl font-black text-inovara-primary mb-2 group-hover:text-inovara-accent transition-colors duration-300">
                            {product.name}
                          </h3>
                      ...
                      <div className={`flex flex-col sm:flex-row gap-3 sm:gap-4 ${isRTL ? 'sm:flex-row-reverse' : ''}`}>
                        <Link
                          ...
                          className="flex-1 group/btn relative overflow-hidden bg-gradient-to-r from-inovara-primary to-inovara-secondary text-white font-bold py-3 sm:py-4 px-4 sm:px-6 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-inovara-accent/30"
                        >
